    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (true) {
                do {
                    myProducer.send(
                            new ProducerRecord<String, String>(topicName, String.format("Batch: %s || %s", Integer.toString(batchNumber), dtFormat.format(new Date())))
                    );
                ...
                } while (counter < 2); // Number of records sent in a batch...
